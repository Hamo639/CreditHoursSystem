...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف ألفا رقمية ورموز بترميز بايت واحد فقط.',
    ...
    'dimensions' => 'لحقل :attribute أبعاد صورة غير صالحة.',
    ...
    'hex_color' => 'يجب أن يكون حقل :attribute لونًا سداسي الأبعاد صالحًا.',
    ...
    'max' => [
        'array' => 'يجب أن لا يحتوي حقل :attribute على أكثر من :max عنصرًا.',
    ...
    'password' => [
        ...
        'uncompromised' => 'يبدو أن :attribute المُعطى قد ظهر في تسريب بيانات. الرجاء اختيار :attribute مختلف.',
    ],
    ...
    'timezone' => 'يجب أن يكون حقل :attribute معرف منطقة زمنية صالحًا.',
